...
public class InputFragment extends Fragment {
    ...
    private void handleOkButtonClick() {
        ...
        saveResultToDatabase(result.toString());
    }
    ...
    private void saveResultToDatabase(String result) {
        ResultDatabaseHelper dbHelper = new ResultDatabaseHelper(getContext());
        dbHelper.insertResult(result);
        Toast.makeText(getContext(), "Result saved to database", Toast.LENGTH_SHORT).show();
    }
